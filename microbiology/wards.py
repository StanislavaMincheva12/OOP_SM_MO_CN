...
class Ward:
    ...
    """
    Represents a hospital ward containing patients.

    Supports patient management and outbreak detection based on pathogen thresholds.
    """
...
class Department:
    ...
    """
    Collection of wards within a hospital.

    Provides aggregation of capacity, patients, and outbreak status.
    """
...
class Hospital:
    ...
    """
    Represents a hospital composed of departments and wards.

    Enables adding and retrieving entities, computing totals, detecting outbreaks,
    and building a hospital structure from a DataFrame.
    """
