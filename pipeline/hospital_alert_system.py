...
"""
The HospitalAlertSystem façade consolidates the 
entire microbiology alert pipeline (DB loading → data prep → 
episode building → alert generation) into a single callable 
interface, meaning the analysis scripts never 
need to know about the internal plumbing. 
"""
